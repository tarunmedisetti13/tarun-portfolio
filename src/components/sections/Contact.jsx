...
export const Contact = () => {
    ...
    return (
        <div className="relative flex flex-col justify-center mb-20 items-center" id="contact">
            ...
            {/* Form */}
            <form onSubmit={handleSubmit} className={` w-100  text-center space-y-6 ${isLoading ? "blur-sm pointer-events-none" : ""}`}>
                ...
                <div className="relative">
                    <textarea
                        ...
                        rows={5}
                        required
                        className="resize-none w-full bg-white/5 border border-white/10 rounded px-4 py-3 text-white transition focus:outline-none focus:border-blue-500"
